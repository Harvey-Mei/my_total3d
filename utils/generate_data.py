...
"""
import sys
# add project root dirction to path
sys.path.append('/home/may/code/my_total3d/')
...
if __name__ == '__main__':
    ...
    print(" ------------------------- write_avg_data(sunrgbd_config)")
    ...
    print(" ------------------------- preprocess without flip")
    train_path_list_no_flip, test_path_list_no_flip = preprocess(sunrgbd_config, gt_config, metadata, iou_threshold=0.1, flip=False)
    print(" ------------------------- preprocess flip training set")
    # flip training set
    train_path_list_flip, test_path_list_flip = preprocess(sunrgbd_config, gt_config, metadata, iou_threshold=0.1, flip=True, data_range=range(5050, 10335)) #data_range=range(5050, 10335)

    # save training path and testing path
    print(" ------------------------- save training path")
